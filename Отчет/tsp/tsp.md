...
Тестирование программы представленно в видео на YouTube: ССЫЛКА (вторая часть)

## UML-Диаграмма классов
UML-Диаграмма классов хранится в папке с отчетом. [UML-Диаграмма](https://github.com/timspk/Отчет/tsp/tsp.png)
